...
class Kritik extends CI_Controller {
	...
	{
		$data["kritik"] = $this->kritik->get_by_warga($_SESSION["id"]);
		$this->load->view('admin/warga/kritik/index', $data);
	}

	public function tambah(){
		$this->load->view('admin/warga/kritik/tambah');
	}
	...
	// // 		$_POST["foto"] = $config['file_name'];
		$this->kritik->save($_POST);
			...
			window.location.href='".base_url('warga/kritik')."';
	 		</script>";
	 	}
