				...
				<div class="page-content">
					...
					<table id="simple-table" class="table  table-bordered table-hover">
						...
						foreach ($pembayaran as $p): ?>
							<tr>
								<td><?= $i ?></td>
								<td width="300px"><?= $p->tgl_bayar ?></td>
								<td width="300px"><?= $p->keterangan ?></td>
								<td>
									<center>
									<?php if ($p->foto_bukti !== ""): ?>										
										<img width="100px" src="<?= base_url()."assets/gambar/".$p->foto_bukti ?>"><br><br>
									<?php else: ?>
								...
								<td width="150px">
									<div class="hidden-sm hidden-xs btn-group">
										...
										<a href="<?= base_url()."rw/pembayaran/edit/".$p->id_bayar ?>">
											<button class="btn btn-xs btn-info">
												<i class="ace-icon fa fa-pencil bigger-120"></i>
											</button>
										</a>										

										<a href="<?= base_url()."rw/pembayaran/hapus/".$p->id_bayar ?>" onClick="return confirm('Hapus pembayaran ini?')">
